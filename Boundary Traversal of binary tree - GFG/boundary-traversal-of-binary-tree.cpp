...
public:
    ...
    vector <int> boundary(Node *root)
    {
        ...
        //for getting data of all nodes that are viewed from left side of the tree
        leftView(root->left, ans);
        //for getting data of all nodes that are viewed from bottoom of the tree
        bottomView(root->left, ans);
        bottomView(root->right, ans);
        //for getting data of all nodes that are viewed from right side of the tree
        rightView(root->right, ans);
